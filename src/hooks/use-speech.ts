...
// Minimal shape of the Web Speech API's SpeechRecognition — not in lib.dom.d.ts by default.
...
/** Spraak-naar-tekst via de Web Speech API (nl-NL). Alleen ondersteund in Chrome/Edge/Safari. */
