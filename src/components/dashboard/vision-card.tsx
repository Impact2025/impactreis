...
export function VisionCard() {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-accent via-surface-inverse to-surface-inverse">
      {/* Subtle wave pattern */}
      ...
      <div className="relative p-6">
        <div className="flex items-start justify-between">
          <div>
            <p className="text-xs text-accent/80 uppercase tracking-wider mb-1">Waarom ik dit doe</p>
        ...
        <div className="flex gap-8 mt-5">
          <div>
            ...
            <p className="text-xs text-ink-soft">dagen te gaan</p>
          </div>
          <div className="h-12 w-px bg-surface-inverse" />
          <div>
            <p className="text-3xl font-bold text-white">€5k</p>
            <p className="text-xs text-ink-soft">/ maand doel</p>
          </div>
        </div>
      </div>
    </div>
